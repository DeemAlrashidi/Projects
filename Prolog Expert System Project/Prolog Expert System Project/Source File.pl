% Daily Use
laptop('Apple MacBook Pro 13 M2 Retina + Touch bar', 1 , 'yes', 'yes').
laptop('Apple MacBook Pro with M2 chip', 1, 'yes', 'no').
laptop('Acer Aspire 3 A315-56',1, 'no', 'yes', 'no', 'yes').
laptop('HP Pavillion 14-dv2022nx',1, 'no', 'yes', 'no', 'no').
laptop('Microsoft Surface Pro 9 2-in-2 laptop',1, 'no', 'yes', 'yes', 'yes').

%Programming
laptop('Dell Inspiron 13 5310',2, 'yes', 'yes', 'yes', 'yes').
laptop('Apple MacBook Air M1',2, 'yes', 'yes', 'yes', 'no').
laptop('Lenovo IdeaPad 5',2, 'yes', 'yes', 'no', 'yes', 'yes').
laptop('Apple MacBook pro 13-inch',2, 'no', 'yes', 'yes').
laptop('Apple MacBook pro 16-inch',2, 'no', 'yes', 'no').
laptop('Asus ROG Zephyrus G15',2, 'no', 'no', 'yes', 'yes').
laptop('HP Spectre x360', 'no',2, 'no', 'no', 'yes', 'no', 'yes').
laptop('Lenovo ThinkPad X1 Extreme',2, 'no', 'no', 'yes', 'no', 'no').

% Gaming and Designing
laptop('ASUS ROG Zephyrus',3, 'yes', 'yes', 'yes', 'yes', 'yes').
laptop('ASUS A15',3, 'yes', 'yes', 'yes', 'yes', 'no').

:- discontiguous category/1.
:- discontiguous q1_DU/0.
:- discontiguous q2_DU/0.
:- discontiguous q4_DU/0.
